...
public class PainelContasPagar extends JPanel {
	...
	public PainelContasPagar(JFrame frameSuperior, UsuarioSistemaDTO usr) {
		...
		JButton novaContasPagar = new JButton("Nova \nContas a Pagar",Util.getImageIcon("coins_add.png"));
		...
		incluir.addActionListener(new ActionListener() {
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				if(Util.isBlankOrNull(data.getText())){
					...
					JOptionPane.showMessageDialog(PainelContasPagar.this,
				...
				cb.setCadastro(new CadastroBean());
//				cb.getCadastro().setIdCadastro(comboFornecedores.getId());
	...
	private JPanel criarPainelCentralCima() {
		...
		String[][] linhas = fs.obterContasPagar();
